...
<html lang="en">
	<head>
		...
		<style type="text/css">
			...
			.cabinet:hover .login-form, .cabinet:focus-within .login-form {
				display: block;
				animation-name: appiarence-moveup;
			...
			.subcategory-dropdown:hover .subcategory-menu, .subcategory-dropdown:focus-within .subcategory-menu {
				display: block;
				animation-name: appiarence-moveup;
				animation-duration: 0.5s;
			}

			.subcategory-dropdown:hover .caret-right, .subcategory-dropdown:focus-within .caret-right {
	...
	<body>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" 
								aria-haspopup="true" aria-expanded="false">Категорії <span class="caret"></span></a>
						...
						<!-- /.dropdown -->
						<li>
							<a href="index.php?download=true"><u>Завантажити
								<b>index.php</b></u></a>
						</li>
					</ul>
				</div><!-- /.navbar-collapse -->
		...
		<div class="container">
			<div class="row">
				...
				<h3>Завдання 2</h3>
						<ul>
							<li>При наведенні на категорію "Комп`ютери", показувати список підкатегорій 
								(без JS, використати масив PHP <b>$sub_categories</b>)</li>
							<li>Не наводячи на пункт "Комп`ютери" потрібно, щоб візуально було видно і 
								зрозуміло, що в ньому є список підкатегорій</li>
				...
				<h3>Завдання 3: </h3>
					<ul>
						<li>Максимально точно зверстати форму по макету вказаному нижче (звернути увагу, 
							що input та checkbox мають не стандартний вид!)</li>
